  ...
  return (
    <div>
      <nav
        ...
        style={{ backgroundColor: "#73A580", height: "60px", margin: "auto" }}
      >
        <div
          className="container"
          style={{ marginLeft: "60px", marginRight: "60px", maxWidth: "100%" }}
        >
      ...
      <div className="jumbotron" style={jumbotronStyle}>
        ...
        >
          <i className="material-icons brand-icon"></i> ANANTA USHI
        </h1>
